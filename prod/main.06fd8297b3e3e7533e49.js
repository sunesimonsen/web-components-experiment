 ...
 */
const r=(e=>e()==e())(()=>e=>e``),s=new Map,n=(new Map,(e,...t)=>i(e,t,s,!1));function i(e,t,o,s){const n=r?e:e.join("{{--uniqueness-workaround--}}");let i=o.get(n);return void 0===i&&(i=new f(e,s),o.set(n,i)),new a(i,t)}class a{constructor(e,t){this.template=e,this.values=t}}const l=`{{lit-${String(Math.random()).slice(2)}}}`,c=`\x3c!--${l}--\x3e`,u=new RegExp(`${l}|${c}`),d=/[ \x09\x0a\x0c\x0d]([^\0-\x1F\x7F-\x9F \x09\x0a\x0c\x0d"'>=/]+)[ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*)$/;function h(e){const t=e.lastIndexOf(">");return e.indexOf("<",t+1)>-1?e.length:t}class p{constructor(e,t,o,r,s){this.type=e,this.index=t,this.name=o,this.rawName=r,this.strings=s}}class f{constructor(e,t=!1){this.parts=[];const o=this.element=document.createElement("template");o.innerHTML=this._getHtml(e,t);const r=o.content;if(t){const e=r.firstChild;r.removeChild(e),w(r,e.firstChild)}const s=document.createTreeWalker(r,133,null,!1);let n=-1,i=0;const a=[];let c,h;for(;s.nextNode();){n++,c=h;const t=h=s.currentNode;if(1===t.nodeType){if(!t.hasAttributes())continue;const o=t.attributes;let r=0;for(let e=0;e<o.length;e++)o[e].value.indexOf(l)>=0&&r++;for(;r-- >0;){const r=e[i],s=d.exec(r)[1],a=o.getNamedItem(s),l=a.value.split(u);this.parts.push(new p("attribute",n,a.name,s,l)),t.removeAttribute(a.name),i+=l.length-1}}else if(3===t.nodeType){const e=t.nodeValue;if(e.indexOf(l)<0)continue;const o=t.parentNode,r=e.split(u),s=r.length-1;i+=s,t.textContent=r[s];for(let e=0;e<s;e++)o.insertBefore(document.createTextNode(r[e]),t),this.parts.push(new p("node",n++))}else if(8===t.nodeType&&t.nodeValue===l){const e=t.parentNode,o=t.previousSibling;null===o||o!==c||o.nodeType!==Node.TEXT_NODE?e.insertBefore(document.createTextNode(""),t):n--,this.parts.push(new p("node",n++)),a.push(t),null===t.nextSibling?e.insertBefore(document.createTextNode(""),t):n--,h=c,i++}}for(const e of a)e.parentNode.removeChild(e)}_getHtml(e,t){const o=e.length-1;let r="",s=!0;for(let t=0;t<o;t++){const o=e[t];r+=o;const n=h(o);r+=(s=n>-1?n<o.length:s)?c:l}return r+=e[o],t?`<svg>${r}</svg>`:r}}const g=(e,t)=>b(t)?(t=t(e),m):null===t?void 0:t,b=e=>"function"==typeof e&&!0===e.__litDirective,m={};class v{constructor(e,t,o,r){this.instance=e,this.element=t,this.name=o,this.strings=r,this.size=r.length-1}_interpolate(e,t){const o=this.strings,r=o.length-1;let s="";for(let n=0;n<r;n++){s+=o[n];const r=g(this,e[t+n]);if(r&&r!==m&&(Array.isArray(r)||"string"!=typeof r&&r[Symbol.iterator]))for(const e of r)s+=e;else s+=r}return s+o[r]}setValue(e,t){const o=this._interpolate(e,t);this.element.setAttribute(this.name,o)}}class x{constructor(e,t,o){this.instance=e,this.startNode=t,this.endNode=o,this._previousValue=void 0}setValue(e){if((e=g(this,e))!==m)if(null===e||"object"!=typeof e&&"function"!=typeof e){if(e===this._previousValue)return;this._setText(e)}else e instanceof a?this._setTemplateResult(e):Array.isArray(e)||e[Symbol.iterator]?this._setIterable(e):e instanceof Node?this._setNode(e):void 0!==e.then?this._setPromise(e):this._setText(e)}_insert(e){this.endNode.parentNode.insertBefore(e,this.endNode)}_setNode(e){this._previousValue!==e&&(this.clear(),this._insert(e),this._previousValue=e)}_setText(e){const t=this.startNode.nextSibling;e=void 0===e?"":e,t===this.endNode.previousSibling&&t.nodeType===Node.TEXT_NODE?t.textContent=e:this._setNode(document.createTextNode(e)),this._previousValue=e}_setTemplateResult(e){let t;this._previousValue&&this._previousValue.template===e.template?t=this._previousValue:(t=new y(e.template,this.instance._partCallback),this._setNode(t._clone()),this._previousValue=t),t.update(e.values)}_setIterable(e){Array.isArray(this._previousValue)||(this.clear(),this._previousValue=[]);const t=this._previousValue;let o=0;for(const r of e){let e=t[o];if(void 0===e){let r=this.startNode;if(o>0){r=t[o-1].endNode=document.createTextNode(""),this._insert(r)}e=new x(this.instance,r,this.endNode),t.push(e)}e.setValue(r),o++}if(0===o)this.clear(),this._previousValue=void 0;else if(o<t.length){const e=t[o-1];t.length=o,this.clear(e.endNode.previousSibling),e.endNode=this.endNode}}_setPromise(e){this._previousValue=e,e.then(t=>{this._previousValue===e&&this.setValue(t)})}clear(e=this.startNode){N(this.startNode.parentNode,e.nextSibling,this.endNode)}}const _=(e,t,o)=>{if("attribute"===t.type)return new v(e,o,t.name,t.strings);if("node"===t.type)return new x(e,o,o.nextSibling);throw new Error(`Unknown part type ${t.type}`)};class y{constructor(e,t=_){this._parts=[],this.template=e,this._partCallback=t}update(e){let t=0;for(const o of this._parts)void 0===o.size?(o.setValue(e[t]),t++):(o.setValue(e,t),t+=o.size)}_clone(){const e=document.importNode(this.template.element.content,!0),t=this.template.parts;if(t.length>0){const o=document.createTreeWalker(e,133,null,!1);let r=-1;for(let e=0;e<t.length;e++){const s=t[e];for(;r<s.index;)r++,o.nextNode();this._parts.push(this._partCallback(this,s,o.currentNode))}}return e}}const w=(e,t,o=null,r=null)=>{let s=t;for(;s!==o;){const t=s.nextSibling;e.insertBefore(s,r),s=t}},N=(e,t,o=null)=>{let r=t;for(;r!==o;){const t=r.nextSibling;e.removeChild(r),r=t}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
function k(e,t){!function(e,t,o=_){let r=t.__templateInstance;if(void 0!==r&&r.template===e.template&&r._partCallback===o)return void r.update(e.values);r=new y(e.template,o),t.__templateInstance=r;const s=r._clone();r.update(e.values),N(t,t.firstChild),t.appendChild(s)}(e,t,C)}const C=(e,t,o)=>{if("attribute"===t.type){if(t.rawName.startsWith("on-")){return new class{constructor(e,t,o){this.instance=e,this.element=t,this.eventName=o}setValue(e){const t=g(this,e),o=this._listener;t!==o&&(this._listener=t,null!=o&&this.element.removeEventListener(this.eventName,o),null!=t&&this.element.addEventListener(this.eventName,t))}}(e,o,t.rawName.slice(3))}if(t.name.endsWith("$")){const r=t.name.slice(0,-1);return new v(e,o,r,t.strings)}return new class extends v{setValue(e,t){const o=this.strings;let r;r=2===o.length&&""===o[0]&&""===o[1]?g(this,e[t]):this._interpolate(e,t),this.element[this.name]=r}}(e,o,t.rawName,t.strings)}return _(e,t,o)};function z(e,t,o){const{type:r,attrName:s}=o;function n(){return this.__values__[t]}Object.defineProperty(e,t,o.computed?{get:n}:{get:n,set:function(e){let o=null===e||void 0===e?e:r===Array?e:r(e);this._setPropertyValue(t,o),s&&this._setAttributeValue(s,o,r),this.invalidate()}})}class V extends HTMLElement{constructor(){super(),this._needsRender=!1,this._lookupCache={},this._attrMap={},this._deps={},this.__values__={},this.attachShadow({mode:"open"});for(const e in this.constructor.properties){const t=this.constructor.properties[e],{value:o,attrName:r,computed:s}=t;"string"==typeof r&&r.length&&(this._attrMap[r]=e),r||void 0===o||this._setPropertyValue(e,o);const n=/(\w+)\((.+)\)/.exec(s);if(n){const t=n[1],o=n[2].split(/,\s*/),r=()=>{const r=o.map(e=>this[e]);if(this[t]&&r.every(e=>void 0!==e)){const o=this[t].apply(this,r);this._setPropertyValue(e,o)}};for(const e of o)this._deps[e]?this._deps[e].push(r):this._deps[e]=[r];r()}}}_setPropertyValue(e,t){this.__values__[e]=t,this._deps[e]&&this._deps[e].map(e=>e())}_setPropertyValueFromAttributeValue(e,t){const o=this._attrMap[e],{type:r}=this.constructor.properties[o];let s;s="Boolean"===r.name?""===t||!!t&&t===e.toLowerCase():null!==t?r(t):void 0,this._setPropertyValue(o,s)}_setAttributeValue(e,t,o){"Boolean"===o.name?t?this.setAttribute(e,""):this.removeAttribute(e):this.setAttribute(e,t)}static get properties(){return{}}static get listeners(){return[]}static get observedAttributes(){return Object.keys(this.properties).map(e=>this.properties[e].attrName).filter(e=>e)}static withProperties(){for(const e in this.properties)z(this.prototype,e,this.properties[e]);return this}renderCallback(){k(this.render(this),this.shadowRoot)}render(e){return n``}attributeChangedCallback(e,t,o){this._setPropertyValueFromAttributeValue(e,o),this.invalidate()}connectedCallback(){for(const e of this.constructor.observedAttributes)this._setPropertyValueFromAttributeValue(e,this.getAttribute(e));this.invalidate().then(()=>{for(const e of this.constructor.listeners){("string"==typeof e.target?this.$(e.target):e.target).addEventListener(e.eventName,e.handler.bind(this))}})}async invalidate(){this._needsRender||(this._needsRender=!0,this._needsRender=await!1,this.renderCallback())}$(e){let t=this._lookupCache[e];if(!t&&this.shadowRoot){const o=this.shadowRoot.getElementById(e);o&&(t=o,this._lookupCache[e]=o)}return t}}customElements.define("z-button",class extends V{render(){return n`
      <style>
        button {
    ...
    `}});customElements.define("z-callout",class extends V{static get properties(){return{title:{type:String,attrName:"title",value:""},type:{type:String,attrName:"type",value:""}}}render(){return n`
      <style>
        .callout {
          display: block;
          position: relative;
    ...
    `}}.withProperties()),customElements.define("z-callout-content",class extends HTMLElement{}),o.d(t,"App",function(){return E});const S=e=>{alert("Click!")};class E extends V{render(){return n`
      <style>
        :host {
      ...
      <section>
        <h1>Buttons</h1>
        <p>This is a custom button: <z-button onclick=${S}><strong>button</strong></z-button></p>
        <p>This is another custom button: <z-button onclick=${S}>Another button</z-button></p>
        <p>This is a normal button: <button onclick=${S}><strong>button</strong></button></p>
      </section>
      <section>
        <h1>Callouts</h1>
        <div class='callouts'>
    ...
    `}}customElements.define("z-app",E);const T=document.createElement("z-app");document.body.appendChild(T)}]);